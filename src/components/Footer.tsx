...
export default function Footer() {
  ...
  return (
    <footer className="w-full min-h-[100dvh] flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 text-center relative overflow-hidden bg-[#4ECDC4]">
      ...
      <div className={`absolute top-[10%] right-[10%] sm:right-[20%] transition-transform duration-[2000ms] ${isActive ? 'rotate-12 scale-100' : '-rotate-45 scale-0'}`}>
        <Star className="w-12 h-12 sm:w-16 sm:h-16 text-[#FFD166]" fill="#FFD166" strokeWidth={3} stroke="#1A535C" />
      </div>

      <div className={`w-full max-w-xl mx-auto relative z-10 transition-all duration-1000 delay-300 ${isActive ? 'scale-100 opacity-100 rotate-1' : 'scale-50 opacity-0 -rotate-12'}`}>
      ...
      <div className={`absolute bottom-2 sm:bottom-4 left-[-2%] sm:left-[2%] md:left-[5%] w-[130px] h-[190px] sm:w-[240px] sm:h-[340px] md:w-[300px] md:h-[400px] z-[100] pointer-events-none transition-all duration-[1500ms] delay-500 cubic-bezier(0.34, 1.56, 0.64, 1) ${isActive ? 'translate-y-0 opacity-100 rotate-[5deg] scale-100' : 'translate-y-32 opacity-0 -rotate-12 scale-50'}`}>
        <div className="w-full h-full animate-bounce" style={{ animationDelay: "0s", animationDuration: "2.5s" }}>
          <Image
            src="/perempuan.png"
      ...
      <div className={`absolute bottom-2 sm:bottom-4 right-[-2%] sm:right-[2%] md:right-[5%] w-[130px] h-[190px] sm:w-[240px] sm:h-[340px] md:w-[300px] md:h-[400px] z-[100] pointer-events-none transition-all duration-[1500ms] delay-700 cubic-bezier(0.34, 1.56, 0.64, 1) ${isActive ? 'translate-y-0 opacity-100 rotate-[-5deg] scale-100' : 'translate-y-32 opacity-0 rotate-12 scale-50'}`}>
        <div className="w-full h-full animate-bounce" style={{ animationDelay: "0.5s", animationDuration: "3s" }}>
          <Image
            src="/pria.png"
            alt="Karakter Pria"
            fill
